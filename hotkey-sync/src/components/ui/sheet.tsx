  ...
  'fixed z-50 gap-4 bg-background p-6 shadow-lg overflow-y-auto',
  {
    variants: {
      side: {
        ...
        left: 'inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm animate-slide-in-right',
        right:
          'inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-sm animate-slide-in-right',
      },
    },
